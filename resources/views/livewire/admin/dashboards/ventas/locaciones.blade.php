<div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p class="text-muted mb-0">Ranking de locaciones por rendimiento y utilidad</p>
        </div>
        <div class="card-body">
              ...
              @if (count($locaciones) > 0)
                                    <div class="table-responsive">
                                        <table class="table" id="locaciones-table">
                                            ...
                                            <tbody>
                                                @forelse($locaciones as $index => $item)
                                                    <tr>
    ...
    <div class="view-product bg-primary-light">
                                                <i class="ti ti-map-pin text-primary"></i>
                                                                ...
                                                                <span class="fw-bold">{{ $item['locacion'] }}</span>
                                                            </div>
                                                        </td>
                                         ...
                                         <tr class="table-primary fw-bold">
                                                    <td></td>
                                                    <td>{{ number_format($totales['Locacion']['horas']) }}</td>
                                                    <td>{{ number_format($totales['Locacion']['pax']) }}</td>
                                                    <td class="fw-bold">${{ number_format($totales['Locacion']['ventaTotal'], 2) }}</td>
                                                    <td class="text-danger">${{ number_format($totales['Locacion']['costo'] , 2) }}</td>
                                                    <td class="text-warning">${{ number_format($totales['Locacion']['descuento'], 2) }}</td>
                                                    <td>{{ number_format($totales['Locacion']['enm_total'] , 2) }}</td>
                                                    <td class="text-center text-warning">{{ number_format($totales['Locacion']['enm_no_pagados_total'] , 2) }}</td>
                                                    <td>{{ number_format($totales['Locacion']['fotos_ingresos'] , 2) }}</td>
                                                    <td class="fw-bold text-success">${{ number_format($totales['Locacion']['ventaIngresos'] , 2) }}</td>
                                                    <td class="fw-bold text-success">${{ number_format($totales['Locacion']['utilidad'] , 2) }}</td>
                                                    <td></td>
                                                </tr>
                                            </tfoot>
                                        </table>
