...
class CargoCredito extends Model
{
      protected $table = 'cargos_credito';
...
/**
     ...
     */
    protected $fillable = [
        'idCC', 'folio', 'fecha', 'referencia', 'importeRecibido', 'comisionRecibido', 'totalRecibido', 'c_monedaRecibida', 
