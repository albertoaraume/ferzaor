    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-warning text-dark">
                ...
                <button type="button" class="btn-close" wire:click="cerrarTodosLosModales"></button>
            </div>
            <div class="modal-body">
                <form wire:submit.prevent="guardarCambios">
                    <div class="row">
                        <div class="col-12 mb-3">
                            <label class="form-label fw-bold">Transportación:</label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="nuevoPrecio" class="form-label">Tarifa <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="nuevaFecha" class="form-label">Fecha de Pickup</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="nuevaHora" class="form-label">Hora de Pickup</label>
