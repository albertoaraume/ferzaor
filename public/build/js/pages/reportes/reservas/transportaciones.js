...
window.addEventListener('abrirModalDetalle', function() {
    ...
    setTimeout(() => {
        const modal = document.getElementById('modalDetalleTraslado');
        if (modal) {
...
if ($.fn.DataTable.isDataTable('#transportacionesTable')) {
$('#transportacionesTable').DataTable().destroy();
}

dataTable = $('#transportacionesTable').DataTable({
"responsive": false,
"autoWidth": false,
"scrollX": true,
"lengthMenu": [
...
<div class="text-center py-5">
    ...
    <i class="fas fa-shuttle-van text-muted" style="font-size: 3rem; margin-bottom: 1rem;"></i>
    <h5 class="text-muted mb-2">No hay transportaciones disponibles</h5>
